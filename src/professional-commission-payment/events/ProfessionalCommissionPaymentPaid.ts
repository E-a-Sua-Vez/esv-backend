...
export default class ProfessionalCommissionPaymentPaid extends DomainEvent {
  constructor(occuredOn: Date, attributes: object, metadata?: object) {
    super('ett.professionalcommissionpayment.1.event.professionalcommissionpayment.paid', occuredOn);
