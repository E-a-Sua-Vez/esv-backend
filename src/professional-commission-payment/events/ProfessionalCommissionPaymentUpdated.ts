...
export default class ProfessionalCommissionPaymentUpdated extends DomainEvent {
  constructor(occuredOn: Date, attributes: object, metadata?: object) {
    super('ett.professionalcommissionpayment.1.event.professionalcommissionpayment.updated', occuredOn);
