...
export default class TelemedicineAccessKeyValidated extends DomainEvent {
  constructor(occuredOn: Date, attributes: object, metadata?: object) {
    super('ett.telemedicine.1.event.telemedicine-session.access-key-validated', occuredOn);
