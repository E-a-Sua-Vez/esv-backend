import { PersonalData, ConsultationReason, CurrentIllness, PatientAnamnese, FunctionalExam, PhysicalExam, Diagnostic, MedicalOrder, AditionalInfo, Control } from '../model/patient-history.entity';
